...
<<<<<<< HEAD:lucene/core/src/test/org/apache/lucene/util/automaton/FiniteStringsIteratorTest.java
...
>>>>>>> ae33c3f25e9... renaming the final tranche of classes to conform to convention.:lucene/core/src/test/org/apache/lucene/util/automaton/TestFiniteStringsIterator.java
  public void testRandomFiniteStrings1() {
    ...
    if (!strings.equals(new HashSet<>(actual))) {
      ...
      for (int i = 0; i < end; i++) {
        System.out.println(
            "  i=" + i + " string=" + toString(x.get(i)) + " actual=" + toString(y.get(i)));
      }
