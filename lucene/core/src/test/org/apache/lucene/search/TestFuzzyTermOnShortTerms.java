...
<<<<<<< HEAD:lucene/core/src/test/org/apache/lucene/search/FuzzyTermOnShortTermsTest.java
...
public class TestFuzzyTermOnShortTerms extends LuceneTestCase {
   ...
   public void test() throws Exception {
      ...
      countHits(a, new String[]{"abc"}, new FuzzyQuery(new Term(FIELD, "ab"), 1), 1);
      countHits(a, new String[]{"ab"}, new FuzzyQuery(new Term(FIELD, "abc"), 1), 1);
>>>>>>> ae33c3f25e9... renaming the final tranche of classes to conform to convention.:lucene/core/src/test/org/apache/lucene/search/TestFuzzyTermOnShortTerms.java
